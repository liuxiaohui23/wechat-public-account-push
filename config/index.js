export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx81d0dc2ec120203d",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "5cafe94f325a624f09b4974a1f3cb750",
  ...
  USERS: [
    {
      ...
      id: "otBQ26KaK4b3f2pDY9NVEyJPPanU",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "Z2M-qlYL9Jr6QJqL2SWUcZlRJD_E2xsPvapeJzMpl60",
      // 所在省份
      province: "广西",
      // 所在城市
      city: "南宁",
      ...
      festivals: [
        ...
        {"type": "节日", "name": "在一起第一天纪念日", "year": "2022", "date": "09-05"},
      ],
  ...
  SLOT_LIST: [
    ...
    {"keyword": "lover_prattle", contents: [
      ...
      "我看什么都像你，我看月亮 ，像你，看星星，也像你。那些白亮透澈、温柔冷清的光，它们都让我想起你。其实我不太懂喜欢，可我想走向你 ´•ﻌ•`",
      "爱你一千遍",
    ]},
    // 你可以不断按格式往下增加
    // ...
